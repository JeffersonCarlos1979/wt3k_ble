...
class Wt3kPRO {
  ...
  //Characteristcs
  static const String AT_PESO_CHARACTERISTIC =
      "0000FFE1-0000-1000-8000-00805f9b34fb";
  //Guid serviços
  static final Guid uuidPesoService = Guid(atPesoService);
  //Guid characteristics
  static final Guid uuidPesoCharacteristic = Guid(AT_PESO_CHARACTERISTIC);
}
